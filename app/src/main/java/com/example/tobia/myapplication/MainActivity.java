...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button suggestedTourBtn = (Button) findViewById(R.id.suggested_tours);
        suggestedTourBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntend = new Intent(getApplicationContext(), SuggestedTour.class);
                startActivity(startIntend);
            }
        });

        Button customTourBtn = (Button) findViewById(R.id.custom_tours);
        customTourBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntend = new Intent(getApplicationContext(), CustomTour.class);
                startActivity(startIntend);
            }
        });
    }
